...
echo $svg;
    ...
    $im->resizeImage(150, 150, imagick::FILTER_LANCZOS, 1);  /*Optional, if you need to resize*/
    $im->writeImage('C:\wamp\www\vocabulaire\avatar\avatar\result\avatar_'.$k.'.png');/*(or .jpg)*/
    $im->resizeImage(45, 45, imagick::FILTER_LANCZOS, 1);  /*Optional, if you need to resize*/
    $im->writeImage('C:\wamp\www\vocabulaire\avatar\avatar\result\avatar_'.$k.'_XS.png');/*(or .jpg)*/
    $im->clear();
    // $im_mini->setBackgroundColor(new ImagickPixel('transparent'));
    // $im_mini->readImageBlob($svg);
    // $im_mini->setImageFormat("png24");
    //
    // $im_mini->resizeImage(50, 50, imagick::FILTER_LANCZOS, 1);  /*Optional, if you need to resize*/
    //
    // $im_mini->writeImage('C:\wamp\www\vocabulaire\avatar\avatar\result\avatar_'.$k.'_XS.png');/*(or .jpg)*/
    // $im_mini->clear();
    $k++;
  }
}
