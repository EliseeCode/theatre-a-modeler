...
<html lang="fr">
  ...
  <pre style="width: 800px;margin: auto;max-width:100%;">
    ...
    These terms and conditions outline the rules and regulations for the use of ExoLingo's
    Website.
    ExoLingo
    (adress a ajouter)
    By accessing this website we assume you accept these terms and conditions in full. Do not
    continue to use ExoLingo's website if you do not accept all of the terms and conditions stated
    on this page.
    ...
    "Us", refers to both the Client and ourselves, or either the Client or ourselves. All terms refer to
    the offer, acceptance and consideration of payment necessary to undertake the process of our
    ...
    prevailing law of Denmark. Any use of the above terminology or other words in the singular,
    plural, capitalisation and/or he/she or they, are taken as interchangeable and therefore as
    referring to same.
    <h2>Cookies</h2>
    We employ the use of cookies. By using ExoLingo's website you consent to the use of
    cookies in accordance with ExoLingo's privacy policy.
    Most of the modern day interactive websites use cookies to enable us to retrieve user details for
    ...
    cookies.
    <h2>License</h2>
    Unless otherwise stated, ExoLingo and/or it's licensors own the intellectual property rights for
    all material on ExoLingo. All intellectual property rights are reserved. You may view and/or
    print pages from https://ExoLingo.com for your own personal use subject to restrictions set in
    these terms and conditions.
    You must not:
    1. Republish material from https://ExoLingo.com
    2. Sell, rent or sub-license material from https://ExoLingo.com
    3. Reproduce, duplicate or copy material from https://ExoLingo.com
    Redistribute content from ExoLingo (unless content is specifically made for redistribution).
    <h3>User Comments</h3>
    1. This Agreement shall begin on the date hereof.
    2. Certain parts of this website offer the opportunity for users to post and exchange
    opinions, information, material and data ('Comments') in areas of the website. ExoLingo
    ApS does not screen, edit, publish or review Comments prior to their appearance on the
    website and Comments do not reflect the views or opinions of ExoLingo, its agents or
    affiliates. Comments reflect the view and opinion of the person who posts such view or
    opinion. To the extent permitted by applicable laws ExoLingo shall not be responsible
    or liable for the Comments or for any loss cost, liability, damages or expenses caused
    and or suffered as a result of any use of and/or posting of and/or appearance of the
    <h3>Comments on this website.</h3>
    3. ExoLingo reserves the right to monitor all Comments and to remove any Comments
    which it considers in its absolute discretion to be inappropriate, offensive or otherwise in
    breach of these Terms and Conditions.
    4. You warrant and represent that:
    1. You are entitled to post the Comments on our website and have all necessary
    ...
    party;
    3. The Comments do not contain any defamatory, libelous, offensive, indecent or
    otherwise unlawful material or material which is an invasion of privacy
    4. The Comments will not be used to solicit or promote business or custom or
    present commercial activities or unlawful activity.
    5. You hereby grant to ExoLingo a non-exclusive royalty-free license to use, reproduce,
    ...
    4. Online directory distributors when they list us in the directory may link to our Web
    site in the same manner as they hyperlink to the Web sites of other listed
    businesses; and
    5. Systemwide Accredited Businesses except soliciting non-profit organizations,
    charity shopping malls, and charity fundraising groups which may not hyperlink to
    our Web site.
    2. These organizations may link to our home page, to publications or to other Web site
    ...
    3. We may consider and approve in our sole discretion other link requests from the
    ...
    We will approve link requests from these organizations if we determine that: (a) the link would
    not reflect unfavorably on us or our accredited businesses (for example, trade associations or
    other organizations representing inherently suspect types of business, such as work-at-home
    opportunities, shall not be allowed to link); (b)the organization does not have an unsatisfactory
    record with us; (c) the benefit to us from the visibility associated with the hyperlink outweighs the
    absence of ; and (d) where the link is in the context of general resource information or is
    ...
    If you are among the organizations listed in paragraph 2 above and are interested in linking to
    our website, you must notify us by sending an e-mail to support@ExoLingo.com. Please include
    ...
    Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for
    a response.
    ...
    No use of ExoLingo's logo or other artwork will be allowed for linking absent a trademark
    license agreement.
    <h3>Iframes</h3>
    ...
    Whilst we endeavour to ensure that the information on this website is correct, we do not warrant
    ...
    materials that may be interpreted as libelous, obscene or criminal, or which infringes, otherwise
    ...
    To the extent that the website and the information and services on the website are provided free
